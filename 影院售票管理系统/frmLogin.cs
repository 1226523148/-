...
namespace 影院售票管理系统
{
    public partial class frmLogin : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            string strUser = "";
            string strPsd = "";
            strUser = this.txtbUsername.Text.ToString();
            strPsd = this.txtbUserpassword.Text.ToString();
        ...
        {
             frmRegisteredId zhuce= new frmRegisteredId();
            zhuce.Show();
        }

        private void btnRegistered_KeyDown(object sender, KeyEventArgs e)
        {
